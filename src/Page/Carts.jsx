...
import { cartSelector, clearProduct } from '../components/redux/Slice/cartsSlice';
...
function Carts() {
    ...
    const { element, totalPrice } = useSelector(cartSelector);
    const totalCount = element.reduce((sum, val) => sum + val.count, 0);
        ...
        <div className="container container--cart">
            <div className="cart">
                ...
                <div className="content__items">
                    {
                        element.map(val => <Cartitem key={val.id} {...val} />)
                    }
                </div>
